...
class BooksController {
    ...
    getOne(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const { id } = req.params;
            const books = yield database_1.default.query('SELECT * FROM books WHERE id = ?', [id]);
    ...
    create(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            const result = yield database_1.default.query('INSERT INTO books set ?', [req.body]);
    ...
    update(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            ...
            yield database_1.default.query('UPDATE books set ? WHERE id = ?', [req.body, id]);
